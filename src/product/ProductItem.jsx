...
export default function ProductItem({ product, variationErrors }) {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-x-4 py-4 border-b-2 border-gray-300 last:border-b-0">
        <div className="flex-grow min-w-0 sm:min-w-[50%] space-y-3 w-full sm:w-auto">
        ...
        <div className="flex items-center justify-between w-full sm:w-auto mt-3 sm:mt-0">
          ...
          {!product.isService && (
            <div className="flex flex-col flex-shrink-0 relative mr-4">
